...
public class BookingPane extends BasicPane {
	...
	private void fillNameList() {
        ...
        Iterator<String> movieNames = db.fetchMovieNames();
        while (movieNames.hasNext()) {
            nameListModel.addElement(movieNames.next());
        }
	}
	...
	private void fillDateList() {
        ...
        Iterator<String> moviePerformances = db.findMoviePerformances(movieName);
        while (moviePerformances.hasNext()) {
           dateListModel.addElement(moviePerformances.next());
        }
	}
	...
	class DateSelectionListener implements ListSelectionListener {
		...
		public void valueChanged(ListSelectionEvent e) {
			...
			CurrentPerformance currentPerformance = db.setCurrentPerformance(movieName, date);
            fields[MOVIE_NAME].setText(currentPerformance.getMovieName());
            fields[PERF_DATE].setText(currentPerformance.getDate());
            fields[THEATER_NAME].setText(currentPerformance.getTheaterName());
            fields[FREE_SEATS].setText(String.valueOf(currentPerformance.getFreeSeats()));
		}
	}
	...
	class ActionHandler implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			if (db.reserveTicket()) {
                ...
                displayMessage("No tickets left I'm afraid");
            }
